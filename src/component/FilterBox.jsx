...
// const FilterBox = ({ isVisible, onClose, data }) => {
...
//   const teams = [...new Set(data.flatMap((user) => user.teams))];

//   useEffect(() => {
//     const queryParams = new URLSearchParams(location.search);
//     const roleFilters = queryParams.getAll("role");
//     const teamFilters = queryParams.getAll("team");
...
//       Object.entries({ role: roles, teams: teams }).forEach(([type, items]) => {
...
//   return (
//     isVisible && (
//       <div className="filter-box bg-white shadow-lg rounded-md p-4 absolute top-14 right-2 w-64 z-50">
//         <div className="flex justify-between mb-2">
//           <button
//             onClick={() => setActiveFilter("role")}
//             className={`text-sm font-medium ${
//               activeFilter === "role" ? "text-blue-500" : "text-gray-600"
//             }`}
//           >
//             Role
//           </button>
...
//             onClick={() => setActiveFilter("teams")}
//             className={`text-sm font-medium ${
//               activeFilter === "teams" ? "text-blue-500" : "text-gray-600"
//             }`}
//           >
//             Teams
//           </button>
